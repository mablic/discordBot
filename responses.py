...
def handle_response(message, check):
    ...
    if '-help' in message:
        ...
        response += "> **-timezone (time difference)**: set your time zone, default Central Time(CT)\n"
        response += "> \t**exampe: -timezone -2**: set your time to LA \n"
        response += "> \t**exampe: -timezone 1**: set your time to New York \n"
        response += "> \t**exampe: -timezone 13**: set your time to China \n"
